const decimalFont: string = `flf2a$ 1 1 11 -1 12 0

decimal.flf by Karlton Wirsing based on
...
to " @".  Change to "@" to remove the hardspace between words.
